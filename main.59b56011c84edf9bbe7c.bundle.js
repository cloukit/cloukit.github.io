...
var ComponentFetchService = (function () {
    ...
    ComponentFetchService.prototype.getModuleSourceCode = function (componentId, componentVersion) {
        return this._fetchDemoFile(componentId, componentVersion, 'demo.imports.txt')
            .map(function (file) { return new __WEBPACK_IMPORTED_MODULE_5__model_component_data_model__["b" /* ComponentPreviewFile */]('app.module.ts', null, injectAppModuleImports(file.sourceCode)); });
    };
    ...
    ComponentFetchService.prototype._fetchDemoFile = function (componentId, componentVersion, demoFileName) {
        ...
        return this.http
            ...
            .map(function (data) { return new __WEBPACK_IMPORTED_MODULE_5__model_component_data_model__["b" /* ComponentPreviewFile */](demoFileName, "" + _this.sourceCodeBaseUrl + componentId + "/blob/gh-pages/" + componentVersion + "/demo/" + demoFileName, data.text()); })
            .catch(this.handleError);
    };
