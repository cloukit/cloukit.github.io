...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private cloukitThemeService: CloukitThemeService
  ) {
    this.cloukitThemeService.registerComponentTheme(
      "smiggle",
      new SmiggleTheme()
    );
  }
  ...
  ngOnInit() {
    this.router.events.takeUntil(this.preDestory).subscribe((routerEvent) => {
      this.isHomePage =
        routerEvent instanceof NavigationEnd && routerEvent.url === "/";
    });
  }
